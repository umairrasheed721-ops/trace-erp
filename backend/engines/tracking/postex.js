...
async function syncPostEx(store, syncType = 'FULL', onProgress) {
  ...
  const updateMany = db.transaction(items => {
    for (const u of items) {
      updateStmt.run(u.courier_status, u.erp_status, u.erp_status, u.erp_status, u.erp_status, u.status_date, u.failed_attempt_increment || 0, u.tracking_history, u.id);
      if (u.watchdogResult) {
