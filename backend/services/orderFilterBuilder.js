function getOrderFilters(req) {
  ...
  if (status && status !== 'All Statuses' && status !== '') {
    ...
    if (s.includes('ACTIVE PIPELINE')) {
      ...
      whereClauses.push("LOWER(o.delivery_status) LIKE '%delivered%' AND (o.paid_amount IS NULL OR o.paid_amount < 1 OR o.paid_amount < o.price) AND (o.payment_status IS NULL OR (o.payment_status != 'Payment Posted' AND o.payment_status != 'Refunded' AND o.payment_status != 'Returned'))");
