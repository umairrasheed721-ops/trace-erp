...
router.put('/:id', (req, res) => {
  const { postex_token, instaworld_key, instaworld_key_backup, instaworld_key_3, store_name, postex_track_url, instaworld_track_url, sync_start_date, gas_proxy_url } = req.body;
