  ...
  try {
    ...
    const ordersQuery = `
      SELECT 
        ...
        SUM(CASE WHEN LOWER(COALESCE(delivery_status, '')) = 'in transit' THEN 1 ELSE 0 END) as intransit,
        SUM(CASE WHEN LOWER(COALESCE(delivery_status, '')) = 'in transit' THEN price ELSE 0 END) as cash_in_transit,
