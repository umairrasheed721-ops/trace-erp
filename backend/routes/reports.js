  ...
  try {
    ...
    const ordersQuery = `
      SELECT 
        ...
        SUM(CASE WHEN LOWER(COALESCE(tags, '')) LIKE '%whatsapp%' AND LOWER(COALESCE(tags, '')) NOT LIKE '%whatsapp%funnel%' THEN price ELSE 0 END) as whatsapp_total_sale,
    ...
    const results = dailyOrders.map(day => {
      ...
      return {
        ...
        whatsappTotalSale: day.whatsapp_total_sale || 0,
        ...
        whatsappDeliveredSale: day.whatsapp_delivered_sale || 0,
        // 📊 WHATSAPP_AOV: Average Order Value of delivered WhatsApp orders. Source: day.whatsapp_delivered_sale, day.whatsapp_delivered
        whatsappAov: (day.whatsapp_delivered || 0) > 0 ? ((day.whatsapp_delivered_sale || 0) / day.whatsapp_delivered) : 0,
