  ...
  try {
    ...
    const ordersQuery = `
      SELECT 
        ...
        SUM(CASE WHEN LOWER(delivery_status) LIKE '%delivered%' AND (paid_amount IS NULL OR paid_amount < 1 OR paid_amount < price) AND (payment_status IS NULL OR (payment_status != 'Payment Posted' AND payment_status != 'Refunded' AND payment_status != 'Returned')) THEN 1 ELSE 0 END) as delivered_payment_pending,
        ...
        SUM(CASE WHEN LOWER(delivery_status) LIKE '%delivered%' AND (paid_amount IS NULL OR paid_amount < 1 OR paid_amount < price) AND (payment_status IS NULL OR (payment_status != 'Payment Posted' AND payment_status != 'Refunded' AND payment_status != 'Returned')) THEN price ELSE 0 END) as unpaid_amount,
