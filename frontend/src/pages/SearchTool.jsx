...
const SPECIAL_MODES = ['[ACTIVE PIPELINE]','[IN TRANSIT]','[STUCK PIPELINE]','[RETURNED]','[PAID]','[READY TO BOOK]','[GHOST PIPELINE]','[NEEDS ADJUSTMENT]','[MISSING COST]','[AUDIT: MISSING CHARGES]','[WATCHDOG FRAUD]','[NO TRACKING]','[UNPAID DELIVERED]']
