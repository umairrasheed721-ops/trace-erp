...
export function getStatusColor(status) {
  ...
  if (s.includes('transit') && !s.includes('return'))           return { bg: 'var(--blue-dim)',   color: 'var(--blue)' }
  ...
  // 🔴 Problem / Loss / Returns
  if (s === 'return in transit')                                return { bg: 'rgba(239, 68, 68, 0.15)', color: '#f87171' }
  if (s === 'return initiated')                                 return { bg: 'rgba(245, 158, 11, 0.15)', color: '#f59e0b' }
