        ...
        if (col.id === 'phone') {
          ...
          return (
            <td key={col.id} className="min-w-[200px] whitespace-nowrap shrink-0" style={{ fontSize: '0.75rem', width: 200, minWidth: 200, maxWidth: 200, overflow: 'visible' }}>
              {formattedPhone ? (
                  /* Single Row: select arrow + Phone number + direct actions inline */
                  <div style={{ display: 'flex', alignItems: 'center', gap: '6px', width: '100%', overflow: 'visible' }}>
                    <div style={{ position: 'relative', display: 'inline-flex', alignItems: 'center', width: '28px', height: '28px', justifyContent: 'center' }}>
                      <select 
                    ...
                    {/* Phone Number Text */}
                    <span className="tabular-nums text-sm font-semibold" style={{ color: 'var(--text-primary)' }}>
                      {phone}
                    </span>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '5px', marginLeft: '6px' }}>
                      ...
                      <a 
                        href={"tel:" + phone} 
                        onClick={() => setActiveRowId(o.id)} 
                        className="phone-action-btn btn-call" 
                        style={{ 
                          display: 'flex',
                          alignItems: 'center',
                          justifyContent: 'center',
                      ...
                      {(() => {
                        ...
                        return (
                          ...
                          >
                            ...
                            {isUnread && <span className="absolute rounded-full" style={{ width: '5px', height: '5px', backgroundColor: '#ef4444', border: '1px solid var(--bg-elevated)', top: '-2px', right: '-2px', display: 'block' }}></span>}
                          </button>
                        );
                      })()}
                    </div>
