        ...
        if (col.id === 'phone') {
          ...
          return (
            <td key={col.id} className="min-w-[250px] whitespace-nowrap shrink-0" style={{ fontSize: '0.75rem', width: 250, minWidth: 250, maxWidth: 250, overflow: 'visible' }}>
              {formattedPhone ? (
                <div className="flex items-center" style={{ display: 'flex', alignItems: 'center', gap: '8px', width: '100%', overflow: 'visible' }}>
                  {/* 1. SIM Call Icon */}
                  <a 
                    href={"tel:" + phone} 
                    onClick={() => setActiveRowId(o.id)} 
                  ...
                  {/* 5. Phone Number Text */}
                  <span className="tabular-nums whitespace-nowrap text-sm font-medium flex-shrink-0" style={{ color: 'var(--text-primary)', marginLeft: '4px' }}>
                    {phone}
                  </span>
                </div>
              ) : '—'}
